...
class _AddExpenseScreenState extends State<AddExpenseScreen> {
  ...
  void initState() {
    ...
    final lastUsedId = widget.storage.getLastUsedCategoryId('expense');
    if (lastUsedId != null) {
  ...
  Future<void> _saveExpense() async {
    ...
    await widget.storage.setLastUsedCategoryId('expense', matchedCategory.id);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(_isEdit ? loc.tr('edit_transaction') : loc.tr('add_expense')),
        centerTitle: true,
        actions: [
